/*******************************************************************************************
 *  @file      BinaryTreePathsSolution.cpp 2015\12\15 13:24:02 $
 *  @author    Wang Xiaotao<wangxt@hiscene.com> (中文编码测试)
 *  @note      LeetCode No.257 Binary Tree Paths
 *******************************************************************************************/

#include "BinaryTreePathsSolution.hpp"
#include "Struct.hpp"
#include <sstream>

 // ------------------------------------------------------------------------------------------
 //
std::vector<std::string> BinaryTreePathsSolution::binaryTreePaths(TreeNode* root)
{
    if (root)
    {
...
// ------------------------------------------------------------------------------------------
//
void BinaryTreePathsSolution::pushNodeInStack(TreeNode* pNode)
{

/*******************************************************************************************
 *  @file      ProductOfArrayExceptSelfSolution.cpp 2015\12\15 10:56:26 $
 *  @author    Wang Xiaotao<wangxt@hiscene.com> (中文编码测试)
 *  @note      LeetCode No.238  Product of Array Except Self
 *******************************************************************************************/

#include "ProductOfArrayExceptSelfSolution.hpp"

 // ------------------------------------------------------------------------------------------
 //
std::vector<int> ProductOfArrayExceptSelfSolution::productExceptSelf(std::vector<int>& nums)
{
    int len = nums.size();

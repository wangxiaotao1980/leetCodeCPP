/*******************************************************************************************
 *  @file      PalindromeLinkedListSolution.cpp 2015\12\15 17:19:04 $
 *  @author    Wang Xiaotao<wangxt@hiscene.com> (中文编码测试)
 *  @note      LeetCode No.234  Palindrome Linked List
 *******************************************************************************************/

#include "PalindromeLinkedListSolution.hpp"
#include "Struct.hpp"
...
// ------------------------------------------------------------------------------------------
//
ListNode* PalindromeLinkedListSolution::reverseList(ListNode* head)
{
